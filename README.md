...
Survive endless waves of computer-themed enemies. Move with WASD or arrow keys, your weapons auto-fire. Collect XP coins to level up and choose from a pool of powerful skills. Three bosses will challenge you at set intervals. How long can you last?
...
- **9 Enemy Types** — Floppy Disk, SSD, Hard Disk, USB Stick, RAID Array, CD/DVD, plus 3 unique Bosses
- **3 Boss Fights** — Overclocked CPU (1:30), Ransomware Rootkit (4:00), NVIDIA RTX 9090 (7:30)
...
| SSD | Charges at player when close |
| Hard Disk | Slow but tanky |
| CD/DVD | Fast and agile |
| RAID Array | Very tanky, high damage |
| Overclocked CPU | Boss — heat waves, periodic charge |
| Ransomware Rootkit | Boss — orbits player, spawns minions, projectile barrage |
| NVIDIA RTX 9090 | Boss — rotating laser beam, fan vortex pull, bullet volley, rage mode |
